...
namespace MistNet
{
    public class MistOptConfigData
    {
        ...
        [JsonProperty("spatialDistanceLayers")] public int SpatialDistanceLayers = 4;
        [JsonProperty("spatialDensityResolution")] public int SpatialDensityResolution = 26; // 1: 6dirs, 2: 14dirs, 3: 26dirs, 4+: Fibonacci sphere
    }
}
