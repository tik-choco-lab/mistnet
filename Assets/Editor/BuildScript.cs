...
namespace UnityBuilderAction
{
    public static class BuildScript
    {
        ...
        public static void Build()
        {
            ...
            if (options.TryGetValue("developmentBuild", out string developmentBuild))
            {
                isDevelopmentBuild = string.IsNullOrEmpty(developmentBuild) || bool.TryParse(developmentBuild, out isDevelopmentBuild) && isDevelopmentBuild;
            }

            var isAddressablesBuild = false;
            if (options.TryGetValue("addressablesBuild", out string addressablesBuild))
            {
                isAddressablesBuild = string.IsNullOrEmpty(addressablesBuild) || bool.TryParse(addressablesBuild, out isAddressablesBuild) && isAddressablesBuild;
            }
            ...
            // Custom build
            Build(buildTarget, buildSubtarget, options["customBuildPath"], isDevelopmentBuild, isAddressablesBuild);
        }
...
// Get all buildOptions from options
        ...
        private static void Build(BuildTarget buildTarget, int buildSubtarget, string filePath, bool isDevelopmentBuild, bool isAddressablesBuild)
        {
            if (isAddressablesBuild)
            {
                ...
                Console.WriteLine("Addressables build completed.");
            }
...
//                targetGroup = BuildPipeline.GetBuildTargetGroup(buildTarget),
                ...
                options = isDevelopmentBuild ? UnityEditor.BuildOptions.Development : UnityEditor.BuildOptions.None,
#if UNITY_2021_2_OR_NEWER
